...
func (a *EnvironmentAPIService) DeleteEnvironmentExecute(r ApiDeleteEnvironmentRequest) (*http.Response, error) {
	...
	if r.retainConsumers != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "retain_consumers", r.retainConsumers, "form", "")
	} else {
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "retain_consumers", defaultValue, "form", "")
