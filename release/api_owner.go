...
func (a *OwnerAPIService) ImportManifestAsyncExecute(r ApiImportManifestAsyncRequest) (*AsyncJobStatusDTO, *http.Response, error) {
	...
	if r.force != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "force", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "force", t, "form", "multi")
		}
	}
	// to determine the Content-Type header
...
func (a *OwnerAPIService) ListEnvironmentsExecute(r ApiListEnvironmentsRequest) ([]EnvironmentDTO, *http.Response, error) {
	...
	if r.listAll != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "list_all", r.listAll, "form", "")
	} else {
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "list_all", defaultValue, "form", "")
...
func (a *OwnerAPIService) ListOwnerPoolsExecute(r ApiListOwnerPoolsRequest) ([]PoolDTO, *http.Response, error) {
	...
	if r.consumer != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "consumer", r.consumer, "form", "")
	}
	if r.activationKey != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "activation_key", r.activationKey, "form", "")
	}
	if r.product != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "product", r.product, "form", "")
	}
	if r.subscription != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "subscription", r.subscription, "form", "")
	}
	if r.listall != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "listall", r.listall, "form", "")
	} else {
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "listall", defaultValue, "form", "")
		r.listall = &defaultValue
	}
	if r.activeon != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "activeon", r.activeon, "form", "")
	}
	if r.matches != nil {
		t := *r.matches
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "matches", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "matches", t, "form", "multi")
		}
	}
	if r.attribute != nil {
		t := *r.attribute
	...
	if r.addFuture != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "add_future", r.addFuture, "form", "")
	} else {
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "add_future", defaultValue, "form", "")
		r.addFuture = &defaultValue
	}
	if r.onlyFuture != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "only_future", r.onlyFuture, "form", "")
	} else {
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "only_future", defaultValue, "form", "")
	...
	if r.poolid != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "poolid", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "poolid", t, "form", "multi")
		}
	}
	if r.page != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "page", r.page, "form", "")
...
func (a *OwnerAPIService) OwnerServiceLevelsExecute(r ApiOwnerServiceLevelsRequest) ([]string, *http.Response, error) {
	...
	if r.exempt != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "exempt", r.exempt, "form", "")
	} else {
		var defaultValue string = "false"
		parameterAddToHeaderOrQuery(localVarQueryParams, "exempt", defaultValue, "form", "")
...
func (a *OwnerAPIService) RefreshPoolsExecute(r ApiRefreshPoolsRequest) (*AsyncJobStatusDTO, *http.Response, error) {
	...
	if r.autoCreateOwner != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "auto_create_owner", r.autoCreateOwner, "form", "")
	} else {
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "auto_create_owner", defaultValue, "form", "")
...
type ApiSetConsumersToEnvironmentsRequest struct {
	ctx context.Context
	ApiService *OwnerAPIService
	ownerKey string
	setConsumerEnvironmentsDTO *SetConsumerEnvironmentsDTO
}
...
func (r ApiSetConsumersToEnvironmentsRequest) SetConsumerEnvironmentsDTO(setConsumerEnvironmentsDTO SetConsumerEnvironmentsDTO) ApiSetConsumersToEnvironmentsRequest {
	r.setConsumerEnvironmentsDTO = &setConsumerEnvironmentsDTO
	return r
}

func (r ApiSetConsumersToEnvironmentsRequest) Execute() (*http.Response, error) {
	return r.ApiService.SetConsumersToEnvironmentsExecute(r)
}

/*
SetConsumersToEnvironments Method for SetConsumersToEnvironments

Sets the environments of the provided consumers to the exact environments that are provided.
When this operation changes any consumer's environments, Candlepin publishes a consumer bulk
modification event that contains the UUIDs of every affected consumer so downstream
systems such as Errata can process the updates.


 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param ownerKey The key of the owner
 @return ApiSetConsumersToEnvironmentsRequest
*/
func (a *OwnerAPIService) SetConsumersToEnvironments(ctx context.Context, ownerKey string) ApiSetConsumersToEnvironmentsRequest {
	return ApiSetConsumersToEnvironmentsRequest{
		ApiService: a,
		ctx: ctx,
		ownerKey: ownerKey,
...
// Execute executes the request
func (a *OwnerAPIService) SetConsumersToEnvironmentsExecute(r ApiSetConsumersToEnvironmentsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OwnerAPIService.SetConsumersToEnvironments")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/owners/{owner_key}/consumers/environments"
	localVarPath = strings.Replace(localVarPath, "{"+"owner_key"+"}", url.PathEscape(parameterValueToString(r.ownerKey, "ownerKey")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.setConsumerEnvironmentsDTO == nil {
		return nil, reportError("setConsumerEnvironmentsDTO is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.setConsumerEnvironmentsDTO
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
