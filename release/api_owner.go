...
func (r ApiCreateEnvRequest) Execute() (*EnvironmentDTO, *http.Response, error) {
...
func (a *OwnerAPIService) CreateEnvExecute(r ApiCreateEnvRequest) (*EnvironmentDTO, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OwnerAPIService.CreateEnv")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
