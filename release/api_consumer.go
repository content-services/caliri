...
func (a *ConsumerAPIService) BindExecute(r ApiBindRequest) (string, *http.Response, error) {
	...
	if r.emailLocale != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "email_locale", r.emailLocale, "form", "")
	}
	if r.async != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "async", r.async, "form", "")
	} else {
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "async", defaultValue, "form", "")
		r.async = &defaultValue
	}
	if r.entitleDate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "entitle_date", r.entitleDate, "form", "")
	}
	if r.fromPool != nil {
		t := *r.fromPool
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "from_pool", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "from_pool", t, "form", "multi")
		}
	}
	// to determine the Content-Type header
...
func (a *ConsumerAPIService) CreateConsumerExecute(r ApiCreateConsumerRequest) (*ConsumerDTO, *http.Response, error) {
	...
	if r.activationKeys != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "activation_keys", r.activationKeys, "form", "")
	}
	if r.identityCertCreation != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "identity_cert_creation", r.identityCertCreation, "form", "")
	} else {
		var defaultValue bool = true
		parameterAddToHeaderOrQuery(localVarQueryParams, "identity_cert_creation", defaultValue, "form", "")
...
func (a *ConsumerAPIService) DryBindExecute(r ApiDryBindRequest) ([]PoolQuantityDTO, *http.Response, error) {
	...
	if r.serviceLevel != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "service_level", r.serviceLevel, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *ConsumerAPIService) ExportCertificatesExecute(r ApiExportCertificatesRequest) (map[string]interface{}, *http.Response, error) {
	...
	if r.serials != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "serials", r.serials, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *ConsumerAPIService) ExportDataExecute(r ApiExportDataRequest) (*os.File, *http.Response, error) {
	...
	if r.cdnLabel != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "cdn_label", r.cdnLabel, "form", "")
	}
	if r.webappPrefix != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "webapp_prefix", r.webappPrefix, "form", "")
	}
	if r.apiUrl != nil {
...
func (a *ConsumerAPIService) GetComplianceStatusExecute(r ApiGetComplianceStatusRequest) (*ComplianceStatusDTO, *http.Response, error) {
	...
	if r.onDate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "on_date", r.onDate, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *ConsumerAPIService) GetComplianceStatusListExecute(r ApiGetComplianceStatusListRequest) (*map[string]ComplianceStatusDTO, *http.Response, error) {
	...
	if r.uuid != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "uuid", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "uuid", t, "form", "multi")
		}
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
type ApiGetConsumerPackagesRequest struct {
	ctx context.Context
	ApiService *ConsumerAPIService
	consumerUuid string
}

func (r ApiGetConsumerPackagesRequest) Execute() (*ExceptionMessage, *http.Response, error) {
	return r.ApiService.GetConsumerPackagesExecute(r)
}

/*
GetConsumerPackages Method for GetConsumerPackages

Placeholder endpoint to expose packages link on the root resource. Consumer package profile uploads are not implemented.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param consumerUuid The UUID of the consumer
 @return ApiGetConsumerPackagesRequest
*/
func (a *ConsumerAPIService) GetConsumerPackages(ctx context.Context, consumerUuid string) ApiGetConsumerPackagesRequest {
	return ApiGetConsumerPackagesRequest{
		ApiService: a,
		ctx: ctx,
		consumerUuid: consumerUuid,
...
func (a *ConsumerAPIService) GetConsumerPackagesExecute(r ApiGetConsumerPackagesRequest) (*ExceptionMessage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ExceptionMessage
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConsumerAPIService.GetConsumerPackages")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/consumers/{consumer_uuid}/packages"
	localVarPath = strings.Replace(localVarPath, "{"+"consumer_uuid"+"}", url.PathEscape(parameterValueToString(r.consumerUuid, "consumerUuid")), -1)
...
func (a *ConsumerAPIService) ListEntitlementsExecute(r ApiListEntitlementsRequest) ([]EntitlementDTO, *http.Response, error) {
	...
	if r.regen != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "regen", r.regen, "form", "")
	} else {
		var defaultValue bool = true
		parameterAddToHeaderOrQuery(localVarQueryParams, "regen", defaultValue, "form", "")
	...
	if r.attribute != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "attribute", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "attribute", t, "form", "multi")
		}
	}
	if r.page != nil {
...
func (a *ConsumerAPIService) RegenerateEntitlementCertificatesExecute(r ApiRegenerateEntitlementCertificatesRequest) (*http.Response, error) {
	...
	if r.lazyRegen != nil {
		...
		var defaultValue bool = true
		parameterAddToHeaderOrQuery(localVarQueryParams, "lazy_regen", defaultValue, "form", "")
		r.lazyRegen = &defaultValue
	}
	if r.cleanupEntitlements != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "cleanup_entitlements", r.cleanupEntitlements, "form", "")
	} else {
		var defaultValue bool = false
		parameterAddToHeaderOrQuery(localVarQueryParams, "cleanup_entitlements", defaultValue, "form", "")
...
type ApiRemoveDeletionRecordsRequest struct {
	ctx context.Context
	ApiService *ConsumerAPIService
	consumerUuid string
}

func (r ApiRemoveDeletionRecordsRequest) Execute() (*http.Response, error) {
	return r.ApiService.RemoveDeletionRecordsExecute(r)
}

/*
RemoveDeletionRecords Method for RemoveDeletionRecords
...
Removes the Deletion Record for a Consumer Allowed for a superadmin. The main use case for this would be if a user accidently deleted a non-RHEL hypervisor, causing it to no longer be auto-detected via virt-who.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param consumerUuid The UUID of the Consumer
 @return ApiRemoveDeletionRecordsRequest
*/
func (a *ConsumerAPIService) RemoveDeletionRecords(ctx context.Context, consumerUuid string) ApiRemoveDeletionRecordsRequest {
	return ApiRemoveDeletionRecordsRequest{
		ApiService: a,
		ctx: ctx,
		consumerUuid: consumerUuid,
...
// Execute executes the request
func (a *ConsumerAPIService) RemoveDeletionRecordsExecute(r ApiRemoveDeletionRecordsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConsumerAPIService.RemoveDeletionRecords")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiSearchConsumersRequest) CheckedInSince(checkedInSince string) ApiSearchConsumersRequest {
	r.checkedInSince = &checkedInSince
	return r
}
...
func (a *ConsumerAPIService) SearchConsumersExecute(r ApiSearchConsumersRequest) ([]ConsumerDTOArrayElement, *http.Response, error) {
	...
	if r.hypervisorId != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "hypervisor_id", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "hypervisor_id", t, "form", "multi")
		}
	}
	if r.checkedInSince != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "checked_in_since", r.checkedInSince, "form", "")
	}
	if r.registrationAuthenticationMethod != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "registration_authentication_method", r.registrationAuthenticationMethod, "form", "")
	}
	if r.fact != nil {
		t := *r.fact
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "fact", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "fact", t, "form", "multi")
		}
	}
